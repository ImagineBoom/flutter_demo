...
class _MenusState extends State<Menus> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<DropdownMenuItem<ColorLabel>> colorItems =
    <DropdownMenuItem<ColorLabel>>[];
    for (final ColorLabel color in ColorLabel.values) {
      colorItems.add(DropdownMenuItem<ColorLabel>(
          value: color, enabled: color.label != 'Grey', child: Text(color.label)));
    }
